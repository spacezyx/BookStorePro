...
INSERT INTO `book` VALUES (1,'1','三体：全三册', '科幻', '刘慈欣', '50.20', '刘慈欣代表作，亚洲首部“雨果奖”获奖作品！',  '10000','1'),
                          ...
                          (4,'4','小王子','世界名著','圣-埃克苏佩里',8.89,'豆瓣9.7高分推荐！旅法翻译家梅子涵之女梅思繁法文直译，舒朗大开本，央美教授高精度还原原作插画。首次收录全球舞台剧、音乐会、电影、动画片等对《小王子》的精彩诠释，通晓名作的前世今生。','500','4'),
                          (5,'5','天龙八部(全五册)', '武侠小说', '金庸', '102.30', '《天龙八部》一书以北宋、辽、西夏、大理并立的历史为宏大背景，将儒释道、琴棋书画等中国传统文化融会贯通其中，书中人物繁多，个性鲜明，情节离奇，尽显芸芸众生百态。','1000', '5'),
                          (6,'6','哈利波特与魔法石', '科幻', 'J·K·罗琳', '30.20', '“沉湎于虚幻的梦想，而忘记现实的生活，这是毫无益处的，千万记住。”                                ——阿不思·邓布利多', '1000','6');
-- ----------------------------
